...
public void CheckBoxNewsLatter () {
CheckBoxNewsLatter.click();
Assert.assertEquals(true, CheckBoxNewsLatter.getAttribute("value"));
System.out.println("-----CheckBoxNewsLatter!!");
